...
import {Paper,TableRow,TableContainer,TableCell,TableBody,Table} from "@mui/material";
...
const ProfileInformation = () => {
  ...
  const rows = [
    createData("Username", "Admin"),
    createData("Company Name", "Admin Dashboard"),
    createData("Email", "admindashboard@gmail.com"),
    createData("Website URL", "www.admindashboard.com"),
    createData("Phone", "09123456"),
    createData("Address", "Wut Yee Street"),
